    ...
    <div className="allNotifications">
      ...
      <div className="allNotification">
        ...
        <div className='allNotification__items allNotification__items--start'>
          <a href='' className='allNotification__link allNotification__link--active--black'>Replies</a>
          <a href='' className='allNotification__link'>Likes</a>
          <a href='' className='allNotification__link'>Other</a>
        ...
        <div className="card">
          {/* <img
              className="card__img"
              src="https://hoptheque.in/testing/project/Nexter/img/realtor-1.jpeg"
            /> */}
          <div className='card__avtar card__bg--4'></div>
          <div className="card__items">
            <p className="card__heading line-height-1 para--dark-3">
              Oliver commented on your post in Product Design                </p>
            <p className="para--size-10 para--dark weight-600">
              8h ago
              </p>
          </div>
          <div className='card__border'>
            ...
            <div className='card__reply'>
              Aenean egestas convallis pulvinar nec pellentesque elementum enim posuere. Eget in iaculis sit in vitae feugiat quis. Malesuada  frozen dquis  hake ac pulvinar...
            </div>
            <div className='card__links'>
              <a href='' className='card__link'>UI/UX</a>
              <a href='' className='card__link'>Product Design</a>
              <a href='' className='card__link'>Career</a>
            </div>
          </div>
        </div>
        {/* 2 */}
        <div className="card">
          {/* <img
              ...
              src="https://hoptheque.in/testing/project/Nexter/img/realtor-1.jpeg"
            /> */}
          <div className='card__avtar card__bg--1'></div>
          <div className="card__items">
            <p className="card__heading line-height-1 para--dark-3">
              Oliver commented on your post in Product Design                </p>
            <p className="para--size-10 para--dark weight-600">
        ...
        <div className="card">
          {/* <img
              ...
              src="https://hoptheque.in/testing/project/Nexter/img/realtor-1.jpeg"
            /> */}
          <div className='card__avtar card__bg--2'></div>
          <div className="card__items">
            <p className="card__heading line-height-1 para--dark-3">
              Oliver commented on your post in Product Design                </p>
            <p className="para--size-10 para--dark weight-600">
        ...
        <div className="card">
          {/* <img
              ...
              src="https://hoptheque.in/testing/project/Nexter/img/realtor-1.jpeg"
            /> */}
          <div className='card__avtar card__bg--3'></div>
          <div className="card__items">
            <p className="card__heading line-height-1 para--dark-3">
              Oliver commented on your post in Product Design                </p>
            <p className="para--size-10 para--dark weight-600">
