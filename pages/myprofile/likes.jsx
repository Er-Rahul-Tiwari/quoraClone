        ...
        <div className="card">
          ...
          <div className="card__items">
            <p className="card__heading line-height-1 para--dark-3">
              How do I start my career as a product designer designer designer our company?
                </p>
          ...
          <div className='card__reply'>
            Aenean egestas convallis pulvinar nec pellentesque elementum enim posuerehull. Eget in iaculis sit
            in vitae feugiat quis. Malesuada quis ac pulvinar risus, aliquam acerad...
            </div>
